...
sed -Ei 's/compileSdkVersion [0-9]{2}/compileSdkVersion 29/g' $BASE_DIR/node_modules/react-native-sqlcipher-2/android/build.gradle
...
sed -Ei 's/compileSdkVersion [0-9]{2}/compileSdkVersion 29/g' $BASE_DIR/node_modules/react-native-fingerprint-scanner/android/build.gradle
sed -Ei 's/targetSdkVersion [0-9]{2}/targetSdkVersion 29/g' $BASE_DIR/node_modules/react-native-fingerprint-scanner/android/build.gradle
